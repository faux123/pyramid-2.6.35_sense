...
static ssize_t show_serial_lock_cpu(struct device *dev,
...
static inline
unsigned int use_low_power_wakeup(struct msm_hs_port *msm_uport)
{
...
/* EXPORT_SYMBOL(ti_dc_msm_hs_request_clock_off_locked);  */
...
/* EXPORT_SYMBOL(ti_dc_msm_hs_request_clock_on_locked); */
...
static int __init msm_serial_hs_init(void)
{
	...
	msm_hs_workqueue = create_singlethread_workqueue("msm_hs_ti_d_wq");
