...
static void __init scpll_init(int sc_pll)
{
	 ...
	 */
#ifdef CONFIG_SYNC_L2_CACHE_FREQ
	regval = (L_VAL_SCPLL_CAL_MAX << 29) | (L_VAL_SCPLL_CAL_MIN << 16);
#else
	regval = (L_VAL_SCPLL_CAL_MAX << 30) | (L_VAL_SCPLL_CAL_MIN << 16);
#endif
