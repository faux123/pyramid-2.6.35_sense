...
struct platform_device *msm_footswitch_devices[] = {
	...
	/*FS(FS_MDP,	"fs_mdp"),*//*re-enable when find out why mdp_p can't turn off*/
	FS(FS_ROT,	"fs_rot"),
	FS(FS_VED,	"fs_ved"),
	FS(FS_VFE,	"fs_vfe"),
	FS(FS_VPE,	"fs_vpe"),
...
struct clk_lookup msm_clocks_8x60[] = {
...
#ifdef CONFIG_MSM_GSBI9_UART
	CLK_8X60("gsbi_uart_clk",	GSBI9_UART_CLK, "msm_serial_hsl.1",
		OFF),
#else
	CLK_8X60("gsbi_uart_clk",	GSBI9_UART_CLK,		NULL, OFF),
#endif
	CLK_8X60("gsbi_uart_clk",	GSBI10_UART_CLK,	NULL, OFF),
	CLK_8X60("gsbi_uart_clk",	GSBI11_UART_CLK, "msm_serial_hsl.3",
		OFF),
	CLK_8X60("gsbi_uart_clk",	GSBI12_UART_CLK, "msm_serial_hsl.0",
		OFF),
	CLK_8X60("gsbi_qup_clk",	GSBI1_QUP_CLK, "spi_qsd.0", OFF),
	CLK_8X60("gsbi_qup_clk",	GSBI2_QUP_CLK, "spi_qsd.1", OFF),
	CLK_8X60("gsbi_qup_clk",	GSBI3_QUP_CLK, "spi_qsd.2", OFF),
	...
	CLK_8X60("gsbi_qup_clk",	GSBI8_QUP_CLK, "spi_qsd.3", OFF),
	CLK_8X60("gsbi_qup_clk",	GSBI9_QUP_CLK, "qup_i2c.2", OFF),
	CLK_8X60("gsbi_qup_clk",	GSBI10_QUP_CLK, "qup_i2c.5", OFF),
	CLK_8X60("gsbi_qup_clk",	GSBI11_QUP_CLK,		NULL, OFF),
	CLK_8X60("gsbi_qup_clk",	GSBI12_QUP_CLK,	"msm_dsps.0", OFF),
	CLK_8X60("gsbi_qup_clk",	GSBI12_QUP_CLK, "qup_i2c.10", OFF),
	...
	CLK_8X60("gsbi_pclk",		GSBI2_P_CLK, "spi_qsd.1", OFF),
	CLK_8X60("gsbi_pclk",		GSBI3_P_CLK, "msm_serial_hsl.2", 0),
	CLK_8X60("gsbi_pclk",		GSBI3_P_CLK, "spi_qsd.2", OFF),
	...
	CLK_8X60("gsbi_pclk",		GSBI8_P_CLK, "spi_qsd.3", OFF),
#ifdef CONFIG_MSM_GSBI9_UART
	...
	CLK_8X60("gsbi_pclk",		GSBI12_P_CLK, "msm_serial_hsl.0", OFF),
	CLK_8X60("gsbi_pclk",		GSBI12_P_CLK, "qup_i2c.10", OFF),
